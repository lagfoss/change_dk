...
ScrollReveal().reveal('.client_cat', { distance: '250px', easing: 'ease-in-out', duration: 700});
ScrollReveal().reveal('.client_about', { distance: '250px', easing: 'ease-in-out', duration: 700});
