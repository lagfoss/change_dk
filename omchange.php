...
ScrollReveal().reveal('.stroke_position_services', { distance: '300px', opacity: 0.5 });
ScrollReveal().reveal('.hero_info h1', { distance: '400px', opacity: 0.5 });
ScrollReveal().reveal('.om_menu_img', { distance: '350px', opacity: 0.5 });
ScrollReveal().reveal('.om_menu a', { distance: '450px', opacity: 0.5 });
ScrollReveal().reveal('.steps_img', { distance: '300px', opacity: 0.5 });
ScrollReveal().reveal('.stroke_om', { distance: '350px', opacity: 0.5 });
ScrollReveal().reveal('.steps_number', { distance: '450px', opacity: 0.5 });
ScrollReveal().reveal('.steps_text h2', { distance: '450px', opacity: 0.5 });
ScrollReveal().reveal('.steps_text p', { distance: '500px', opacity: 0.5 });
ScrollReveal().reveal('.om_button a', { distance: '30px', opacity: 0.5 });
ScrollReveal().reveal('.om_button img', { distance: '400px', opacity: 0.5 });
ScrollReveal().reveal('.arrow_left img', { distance: '350px', opacity: 0.5 });
ScrollReveal().reveal('.arrow_right img', { distance: '350px', opacity: 0.5 });
ScrollReveal().reveal('.quote_img', { distance: '350px', opacity: 0.5 });
ScrollReveal().reveal('.quote', { distance: '400px', opacity: 0.5 });
ScrollReveal().reveal('.quote_name', { distance: '450px', opacity: 0.5 });
ScrollReveal().reveal('.quote_logo', { distance: '500px', opacity: 0.5 });
ScrollReveal().reveal('.om_slider_title', { distance: '350px', opacity: 0.5 });
ScrollReveal().reveal('.stroke_position', { distance: '450px', opacity: 0.5 });
ScrollReveal().reveal('.carousel_om_change', { distance: '550px', opacity: 0.5 });
</script>
