...
ScrollReveal().reveal('.hero_title', { distance: '250px', easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.hero_text', { distance: '300px',easing   : 'ease-in-out', duration: 2000  });
ScrollReveal().reveal('.hero_button', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.1', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.playcircle', { distance: '300px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.watch', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.showreel', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.wrapper_cases', { distance: '400px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.process_img', { distance: '300px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('h2', { distance: '400px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.process_steps', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.process_steps_text', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.font-weight-normal', { distance: '400px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.wcwd_img', { distance: '250px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.wcwd_content h3', { distance: '300px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.wcwd_content p', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.wcwd_button', { distance: '300px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.wcwd_button img', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.logo_slider', { distance: '400px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.know_us_dots', { distance: '250px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.know_us_content h2', { distance: '300px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.know_us_content p', { distance: '400px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.know_button', { distance: '350px',easing   : 'ease-in-out', duration: 2000 });
ScrollReveal().reveal('.know_button img', { distance: '450px',easing   : 'ease-in-out', duration: 2000  });
